...
public partial class business_other_QueryEmployeeInfo : System.Web.UI.Page
{
    #region Page_Load
    ...
    {
        ayjz_employeeinfoLogic logic = new ayjz_employeeinfoLogic();
        List<ayjz_employeeinfoInfo> list = logic.Getayjz_employeeinfoList(string.Format(" And xm like '%{0}%'", txtXM.Text));
