<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="EditUser.aspx.cs" Theme="Default" Inherits="admin_UserManager_EditUser" %>
...
<table border="0" cellspacing="0" cellpadding="1" width="100%" class="StandardTable">
    <tr>
        <td class="trr">
            帐号：</td>
        <td class="trl">
            <asp:TextBox ID="TXT_USERCODE" runat="server" Enabled="false"></asp:TextBox><font color="Red">*(用户帐号必须唯一)</font>
        </td>
    </tr>
    <tr>
        <td class="trr">
